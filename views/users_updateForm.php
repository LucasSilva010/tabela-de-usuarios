    ...
    <div class="col-md-4">
      ...
      <form id="updateForm" class="col-md-12" action="../actions/users_edit.php" method="post">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="nameInput" name="nameInput" placeholder="Seu nome" value="<?php echo $nome ?>" required>
          <div class="invalid-feedback">Informe um nome válido (somente letras e espaços).</div>
        </div>
        <div class="form-group">
          <label for="emailInput">E-mail:</label>
          <input type="email" class="form-control" id="emailInput" name="emailInput" placeholder="Seu email" value="<?php echo $email ?>" required>
          <div class="invalid-feedback">Informe um email válido.</div>
        </div>
        <div class="form-group">
          <label for="functionInput">Função:</label>
          <input type="text" class="form-control" id="functionInput" name="functionInput" placeholder="Sua função" value="<?php echo $funcao ?>" required>
