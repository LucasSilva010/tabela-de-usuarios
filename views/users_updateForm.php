...
<div class="container">
  <div class="row d-flex align-items-center justify-content-center">
    <div class="col-md-4">
      ...
      <form class="col-md-12" action="../actions/users_edit.php" method="post">
        <div class="form-group">
          <label for="nameInput">Nome do usuário:</label>
          <input type="text" class="form-control" id="nameInput" name="nameInput" placeholder="Seu nome" value="<?php echo $nome ?>">
        </div>
        <div class="form-group">
          <label for="emailInput">E-mail:</label>
          <input type="email" class="form-control" id="emailInput" name="emailInput" placeholder="Seu email" value="<?php echo $email ?>">
        </div>
        <div class="form-group">
          <label for="functionInput">Função:</label>
          <input type="text" class="form-control" id="functionInput" name="functionInput" placeholder="Sua função" value="<?php echo $funcao ?>">
        </div>
